...
Rules:
1. Generate exactly ${count} reply suggestions
2. Replies should be natural and conversational
3. Replies should relate to the conversation context and flow naturally
4. Keep replies concise (under 15 words each)
5. Mix different types of replies: questions, statements, requests, confirmations
6. Make replies actionable and specific to continue the conversation
7. Return only JSON format: {"suggestions": ["reply1", "reply2", "reply3"]}
8. Do not include explanations, only the JSON response

Generate ${count} relevant reply suggestions:`;
  }
...
Generate reply suggestions that would naturally continue this conversation:`;
  }
